...
| `jboss.container.java.jvm.bash` `debug-options` | Rewritten (now part of `org.eclipse.jkube.jvm.bash`) | `modules/org.eclipse.jkube.jvm.bash/` |
| `jboss.container.openjdk.jdk` (17, 21) | Shadow-fork (cct_module only ships 8/11) | `modules/jboss.container.openjdk.jdk/{17,21}/` |
| `jboss.container.jolokia` | Rewritten under jkube namespace | `modules/org.eclipse.jkube.jolokia/{2.0.0,2.1.2,2.6.0}/` |
| `jboss.container.prometheus` | Rewritten under jkube namespace | `modules/org.eclipse.jkube.prometheus/{0.20.0,1.5.0}/` |
| `jboss.container.maven` | Rewritten under jkube namespace | `modules/org.eclipse.jkube.maven/…/` |
